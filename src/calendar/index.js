...
class Calendar extends Component {
  ...
  renderDay(day, id) {
    ...
    if (this.props.disabledByDefault) {
      ...
      state = 'disabled';
    } else if (!dateutils.sameMonth(day, this.state.currentMonth, this.props.jalali)) { // # jalali
      state = 'disabled';
    } else if (dateutils.sameDate(day, XDate())) {
      state = 'today';
    }
    let dayComp;
    if (!dateutils.sameMonth(day, this.state.currentMonth, this.props.jalali) && this.props.hideExtraDays) { // # jalali
